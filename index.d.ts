...
export declare function format(arg: string | Date): string;
export declare function format(fmt: string, date: Date): string;
export declare function format(fmt: string, date: string): string;
export declare function format(fmt: string, year: number, month: number, day: number, hour?: number, minute?: number, second?: number): string;
